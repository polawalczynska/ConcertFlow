        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          {features.slice(0, 5).map((feature, index) => {
            ...
            return (
              <div
                key={feature.title}
                className="group bg-white p-6 rounded-2xl border border-slate-200 hover:border-purple-200 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 hover:-translate-y-1"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-700 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-purple-500/20">
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={index} className="text-center">
              <div className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-purple-main to-purple-dark bg-clip-text text-transparent mb-2">
                {stat.value}
              </div>
