        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/signup" className="hover:text-white transition-colors">Integrations</Link></li>
              <li><Link to="/signup" className="hover:text-white transition-colors">Changelog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/signup" className="hover:text-white transition-colors">About</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/signup" className="hover:text-white transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
