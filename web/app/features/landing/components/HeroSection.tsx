...
import { ArrowRight, Sparkles, Music, Mic2 } from "lucide-react";
  ...
  return (
    <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-96 h-96 bg-blue-200/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-20 left-1/3 w-64 h-64 bg-pink-200/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>

      {/* Floating icons */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <Music className="absolute top-32 left-[15%] w-8 h-8 text-purple-300/40 animate-bounce-subtle" />
        <Sparkles className="absolute top-48 right-[20%] w-6 h-6 text-amber-300/50 animate-bounce-subtle" style={{ animationDelay: '0.5s' }} />
        <Mic2 className="absolute bottom-32 left-[25%] w-7 h-7 text-blue-300/40 animate-bounce-subtle" style={{ animationDelay: '1s' }} />
        <Music className="absolute top-64 right-[10%] w-5 h-5 text-pink-300/40 animate-bounce-subtle" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-slate-900 mb-6 tracking-tight">
            Perfect Concerts.
            <br />
            <span className="bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-500 bg-clip-text text-transparent animate-fade-in">
              Seamless Workflow.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              to="/signup"
              className="group bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/30 transition-all hover:scale-105 flex items-center gap-2"
            >
              Get Started Free
