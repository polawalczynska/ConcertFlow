      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-slate-900 mb-6">
            Perfect Concerts.
            <br />
            <span className="bg-gradient-to-r from-pink-main via-pink-light to-pink-dark bg-clip-text text-transparent">
              Seamless Workflow.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              to="/signup"
              className="group bg-pink-main text-white px-8 py-4 rounded-lg text-lg font-semibold hover:shadow-xl transition-all hover:scale-105 flex items-center gap-2"
            >
              Get Started
