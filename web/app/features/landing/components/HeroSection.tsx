  ...
  return (
    <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-5 overflow-hidden pointer-events-none">
        ...
        <Mic2 className="absolute top-48 right-[20%] w-10 h-10 text-purple-400/30 animate-bounce-subtle" style={{ animationDelay: '0.5s' }} />
        <Users className="absolute bottom-32 left-[25%] w-9 h-9 text-purple-300/30 animate-bounce-subtle" style={{ animationDelay: '1s' }} />
        <Sparkles className="absolute bottom-48 right-[15%] w-7 h-7 text-purple-400/40 animate-bounce-subtle" style={{ animationDelay: '1.5s' }} />
      </div>

      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-100/80 backdrop-blur-sm border border-purple-200 mb-8 animate-fade-in">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-slate-900 mb-6 tracking-tight animate-fade-in" style={{ animationDelay: '0.1s' }}>
            Perfect Concerts.
            <br />
            <span className="bg-gradient-to-r from-purple-600 via-purple-main to-purple-dark bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">
              Seamless Workflow.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <Link
              to="/signup"
              className="group relative bg-gradient-to-r from-purple-600 to-purple-main text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/30 transition-all hover:scale-105 flex items-center gap-2 overflow-hidden"
            >
              <span className="absolute inset-0 bg-gradient-to-r from-purple-main to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity" />
              <span className="relative">Get Started Free</span>
              <ArrowRight className="relative w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link
              to="/login"
              className="group border-2 border-slate-200 text-slate-700 px-8 py-4 rounded-xl text-lg font-semibold hover:border-purple-300 hover:bg-purple-50/50 transition-all backdrop-blur-sm"
            >
              Sign In
